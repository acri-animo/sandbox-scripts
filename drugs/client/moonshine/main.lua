        ...
        Targeting:AddObject(v, "kitchen-set", {
            {
                ...
                isEnabled = function(data, entity)
                    ...
                    return entState?.isMoonshineStill and (LocalPlayer.state.onDuty == "police")
                end,
            },
            {
                text = "Still Info",
            ...
            },
            {
                ...
                isEnabled = function(data, entity)
                    local entState = Entity(entity.entity).state
                    return entState?.isMoonshineStill and (not _stills[entState.stillId]?.cooldown or GetCloudTimeAsInt() > _stills[entState.stillId]?.cooldown)
                end,
            },
            {
                text = "Collect Brew",
                ...
                isEnabled = function(data, entity)
                    local entState = Entity(entity.entity).state
                    return entState?.isMoonshineStill and _stills[entState.stillId]?.pickupReady == true
                end,
            },
        }, 3.0)
    end
        ...
        Targeting:AddObject(v, "prescription-bottle", {
            {
                ...
                isEnabled = function(data, entity)
                    local entState = Entity(entity.entity).state
                    return entState?.isMoonshineBarrel and (LocalPlayer.state.onDuty == "police")
                end,
            },
            {
                text = "Barrel Info",
            ...
            },
            {
                ...
                isEnabled = function(data, entity)
                    local entState = Entity(entity.entity).state
                    return entState?.isMoonshineBarrel and _barrels[entState.barrelId]?.pickupReady == true
                end,
            },
        }, 3.0)
    end
