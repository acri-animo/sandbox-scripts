...
local strains = {
	...
	["bluekush"] = "Blue Kush",
	["granddaddy"] = "Grand Daddy Purp",
	["bluehaze"] = "Blue Haze",
	["purpdream"] = "Purple Dream",
	["cherrypie"] = "Cherry Pie",
	["gelatopurp"] = "Gelato Purp",
	["gscookies"] = "Girl Scout Cookies",
	["sourdiesel"] = "Sour Diesel",
	["gorillaglue"] = "Gorilla Glue",
}
...
AddEventHandler("Weed:Client:Check", function(entity, data)
	Callbacks:ServerCallback("Weed:CheckPlant", GetWeedPlant(entity.entity), function(data)
		if data ~= nil then
			...
			local strain = data.plant.strain
			local strainLabel = strains[strain] or "Unknown Strain"
			local stage = Plants[strain][stageId]
			...
			local items = {
				{
					...
					description = string.format(
						"<ul><li>Strain: %s</li><li>Stage: %s</li><li>Type: %s</li></ul>",
						strainLabel,
						stageId,
						type
					),
