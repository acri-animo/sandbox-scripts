function RegisterCommands()
	Chat:RegisterStaffCommand("logout", function(source, args, rawCommand)
		exports["lumen-base"]:FetchComponent("Execute"):Client(source, "Characters", "Logout")
	end, {
		help = "Logout",
	}, 0)
	Chat:RegisterStaffCommand("logoutsid", function(source, args, rawCommand)
		...
		if char ~= nil then
			exports["lumen-base"]:FetchComponent("Execute"):Client(char:GetData("Source"), "Characters", "Logout")
		end
	end, {
	...
	Chat:RegisterStaffCommand("logoutsource", function(source, args, rawCommand)
		exports["lumen-base"]:FetchComponent("Execute"):Client(tonumber(args[1]), "Characters", "Logout")
	end, {
	...
	Chat:RegisterAdminCommand("logoutall", function(source, args, rawCommand)
		for k, v in pairs(Fetch:All()) do
			exports["lumen-base"]:FetchComponent("Execute"):Client(v:GetData("Source"), "Characters", "Logout")
		end
	end, {
