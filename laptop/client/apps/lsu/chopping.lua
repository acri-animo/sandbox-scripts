...
LAPTOP.LSUnderground.Chopping = {
	CreateBlips = function(self)
		if Reputation:HasLevel("CarRobbery", 3) or hasValue(LocalPlayer.state.Character:GetData("States") or {}, "ACCESS_LSUNDERGROUND") then
		...
		if Reputation:HasLevel("CarRobbery", 3) and (Reputation:HasLevel("Chopping", 3) or hasValue(LocalPlayer.state.Character:GetData("States") or {}, "ACCESS_LSUNDERGROUND")) then
...
AddEventHandler("Polyzone:Enter", function(id, testedPoint, insideZones, data)
	if
		(id == "chopping_public" and Reputation:HasLevel("CarRobbery", 3))
		or (id == "chopping_private" and LocalPlayer.state.Character ~= nil and (
			Reputation:HasLevel("Chopping", 3) or
