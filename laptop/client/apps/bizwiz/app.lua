...
RegisterNUICallback("PosItemsFetchEdit", function(data, cb)
	Callbacks:ServerCallback("Pos:Server:RefreshPOSItems", data, cb)
end)

RegisterNUICallback("PosItemCreate", function(data, cb)
	Callbacks:ServerCallback("Pos:Server:CreatePOSItem", data, cb)
end)

RegisterNUICallback("PosItemUpdatePrice", function(data, cb)
	Callbacks:ServerCallback("Pos:Server:UpdatePOSItemPrice", data, cb)
end)